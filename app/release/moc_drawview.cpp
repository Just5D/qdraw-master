...
void DrawView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DrawView::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DrawView::positionChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DrawView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_DrawView.data,
      qt_meta_data_DrawView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
